  ...
  >
      ...
      >
        ...
        >
          ...
          <Stack direction={"row"} alignItems={"center"} spacing={1} justifyContent={"center"} width={"100%"}>
          ...
          <MotionTypography
            ...
            fontWeight={900}
          >
            CHALLENGE THE MARKET WITH <span style={{color: "gold"}}> SyntriDigital WEB APP </span>
          </MotionTypography>
          ...
          >
            Join over 26 million users who have already chosen the SyntriDigital
            web app for trading.
          </MotionTypography>
