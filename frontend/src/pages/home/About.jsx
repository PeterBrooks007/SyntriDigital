          ...
          >
            <Box sx={{ flex: "50%" }}>
              ...
              <Typography variant={isMobile ? "subtitle2" : "body1"} color={"grey"}>
                SyntriDigital Investment offers state-of-the-art trading technology
                ...
                SyntriDigital Investment’s fully customizable market monitoring,
                charting and analysis tools help clients to identify and act
                instantly on trading opportunities. The first-of-its-kind
                SyntriDigital Investment Trading Planing offers hundreds of custom
                SyntriDigital Investment-compatible software products – indicators,
                strategies and other apps – that further amplify the power of
                the SyntriDigital Investment platform. With SyntriDigital Investment web
        ...
        <Container maxWidth="xl">
          ...
          >
            ...
            <Typography variant={isMobile ? "h4" : "h3"} sx={{ mb: 1 }} fontWeight={"500"}>
              ...
              <Typography variant={isMobile ? "subtitle2" : "body1"} color={"grey"}>
                At SyntriDigital Investment we believe in empowering traders to claim
                ...
                market access, and competitive pricing models. At SyntriDigital
            ...
            >
              <Box flex={"50%"}>
                ...
                <Typography
                  ...
                  color={"grey"}
                >
                  SyntriDigital EURUSD Avg spread of 0.1 is one of the
          ...
          >
            <Box sx={{ flex: "50%" }}>
              ...
              <Typography variant={isMobile ? "subtitle2" : "body1"} color={"grey"}>
                ...
                analysis. <br />
                <br /> SyntriDigital is the one of the top choices for
...
From the pioneers like Bitcoin (BTC) and Ethereum (ETH) to emerging altcoins with promising potential, the cryptocurrency market offers a vast selection of assets to explore. Each asset comes with unique characteristics and use cases, enabling traders to tailor their strategies to specific goals.
       ...
       <Container maxWidth="xl">
        ...
        <Box
          ...
          color={"white"}
        >
      (c) Copyright © {new Date().getFullYear()} SyntriDigital, Inc.       
       </Box>
      </Box>
    </>
  );
