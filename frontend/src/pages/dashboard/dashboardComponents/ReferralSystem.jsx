          ...
          <CardActionArea disableRipple>
            ...
            <CardContent>
              ...
              >
                <TextField
                  value={
                    "http://syntridigital.com/auth/register"
                  }
            ...
            >
                <Button
                  ...
                  color="secondary"
                  onClick={() =>
                    handleCopyReferralLinkMobile("http://syntridigital.com/auth/register")
                  }
                >
                  Copy Link
                </Button>
        ...
        >
          ...
          <Stack direction={"row"} spacing={1}>
            ...
            <Button
              ...
              color="secondary"
              onClick={() =>
                handleCopyReferralLink("http://syntridigital.com/auth/register")
              }
            >
              Copy Link
            </Button>
          ...
          {/* <Typography variant="subtitle2">
            http://syntridigital.com/register
          </Typography> */}
        </Stack>
      </Stack>
